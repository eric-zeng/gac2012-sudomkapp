 ...
 * @author Leo Dihong Gao, Dina Lamdany
 *
 */
...
//    	Log.d("photobath", photoPath);
		...
		long id = db.addPoint(new Point(name, currentTrip, (int)(latitude*1E6), (int)(longitude*1E6), /**Calendar.getInstance().getTimeInMillis()*/ 1234, note, photoPath));
